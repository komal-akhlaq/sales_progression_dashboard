...
page = st.sidebar.selectbox("Choose a report", ["Sales Leads Monitoring", "Client Stage Progression Report", "Low Sales Progression", "Sales Rep Daily Report", "May Account Assigned Clients"])
